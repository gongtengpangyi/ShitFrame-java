...
public class ShitReflectHelper {
	...
	static {
		...
		stringCastTypeMap.put(java.util.Date.class, ShitStringCastDate.newInstance(ShitStringCastDate.defaultDateFormatStr));
	}
	 ...
	 * @return 实例化的对象
	 */
	public static Object instanceConstructor(Constructor<?> constructor, Object... params) {
		try {
	 ...
	 * @return 方法
	 */
	public static Method findMethodByName(Class<?> clazz, String name, Class<?>[] parameterTypes,
	...
	public static Object invokeMethodByName(Object obj, Class<?> clazz, String name, Class<?>[] parameterTypes,
			boolean includeSuper, Object... params) {
	 ...
	 * @return 字段
	 */
	public static Field findFieldByName(Class<?> clazz, String name, boolean includeSuper) {
		try {
	...
	public static Object invokeObjectMethodByName(Object obj, Class<?> clazz, String methodName, String[] paramsName,
			boolean includeSuper, String... values) {
	 ...
	 * @return get返回值
	 */
	public static Object getValue(Object obj, String fieldName, boolean includeSuper) {
